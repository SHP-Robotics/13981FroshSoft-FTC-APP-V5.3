...
{
    public DcMotor leftBackDriveMotor, rightBackDriveMotor, leftFrontDriveMotor, rightFrontDriveMotor;
    BNO055IMU               imu;
    ...
    public void runOpMode() throws InterruptedException
    {
       ...
       leftBackDriveMotor.setDirection(DcMotor.Direction.REVERSE);
       leftFrontDriveMotor.setDirection(DcMotor.Direction.REVERSE);
        ...
        while (opModeIsActive())
        {
            ...
            leftBackDriveMotor.setPower(power - correction);
            leftFrontDriveMotor.setPower(power - correction);

            rightBackDriveMotor.setPower(power + correction);
            rightFrontDriveMotor.setPower(power + correction);
